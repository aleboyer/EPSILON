...
%% 
root_data='/Users/aleboyer/ARNAUD/SCRIPPS/NUWC/DIPTEST/dip_test5/d1/epsi/';

%% 	get data 
Profiles{1}=load([root_data '20180306_122307_EPSI.mat']);
...
for i=1:length(Profiles)
    ...
    Profiles{i}.P=interp1(CTDprofiles{i}.ctdtime,CTDprofiles{i}.P,Profiles{i}.time);
    Profiles{i}.T=interp1(CTDprofiles{i}.ctdtime,CTDprofiles{i}.T,Profiles{i}.time);
...
%    Profiles{i}.S=interp1(CTDprofiles{i}.time,CTDprofiles{i}.S,Profiles{i}.time);
    Profiles{i}.S=interp1(CTDprofiles{i}.ctdtime,S,Profiles{i}.time);
